...
export default function FilterChips({ categories, active, search }: FilterChipsProps) {
  return (
    <div className="sticky top-14 z-40 bg-[#0f0f0f] border-b border-[#272727] pl-14">
      <div className="flex gap-3 pr-6 py-3 overflow-x-auto scrollbar-none [&::-webkit-scrollbar]:hidden">
        {categories.map(cat => {
